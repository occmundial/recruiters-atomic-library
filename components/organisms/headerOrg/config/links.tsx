...
export const getRoot = (local: boolean = false, dev: boolean = false, prod: boolean = false) => {
...
export const dummyOrganizationsAndTeams = (tabSelected = 0) => (
  [
    {
      url: '#', text: 'Organización 1', unclickable: true,
    },
    {
      url: '#', text: 'Equipo 1', visible: true, selected: tabSelected === 1,
    },
    {
      url: '#', text: 'Equipo 2', visible: true, selected: tabSelected === 2,
    },
    { url: '', separator: true },
    {
      url: '#', text: 'Organización 2', unclickable: true,
    },
    {
      url: '#', text: 'Equipo 1', visible: true, selected: tabSelected === 3,
    },
    {
      url: '#', text: 'Equipo 2', visible: true, selected: tabSelected === 4,
    },
    { separator: true },
    {
      url: '#', text: 'Organización 3', unclickable: true,
    },
    {
      url: '#', text: 'Equipo 1', visible: true, selected: tabSelected === 5,
    }, 
    {
      url: '#', text: 'Equipo 2', visible: true, selected: tabSelected === 6,
    },
  ]
);
...
export const dummyOrganizations = (tabSelected = 0) => (
  [
    {
      url: '#', text: 'Organización 1', visible: true, selected: tabSelected === 1,
    },
    {
      url: '#', text: 'Organización 2', visible: true, selected: tabSelected === 2,
    },
    {
      url: '#', text: 'Organización 3', visible: true, selected: tabSelected === 3,
    },
  ]
);
