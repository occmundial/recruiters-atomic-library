...
import styles from '../../../styles/HeaderOrg.module';
...
import AtomicWrapper from '../../molecules/atomicWrapper';
...
const HeaderOrg = ({
  ...
  const createAccount = () => {
    ...
    window.location.href =
      ...
      `${linksRoot.accounts}/${
        links.newAccount
      }?btn=header&${getCreateAccountUrl(enviroments)}`;
  };
